    ...
    <div className="max-w-2xl w-full p-6 flex-1 flex flex-col gap-4 items-center">
      <ul className="space-y-4">
        { listUsers?.map((user) => {
            ...
            return(
              <li key={user.login}>
                <Link href={`/list/${user.login}`} className="py-2 px-3 flex items-center gap-2 text-xl rounded-md no-underline bg-neutral-100 hover:bg-neutral-200 active:bg-neutral-300">
